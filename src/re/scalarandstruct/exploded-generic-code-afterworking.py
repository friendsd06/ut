...
def join_exploded_dfs(source_df_dict, target_df_dict, array_columns, primary_keys):
    ...
    for array_column in array_columns:
        ...
        common_keys = [col_name for col_name in struct_fields if col_name.endswith('_id')]

        source_keys = primary_keys + common_keys
...
def compare_fields_generic(joined_df, fields, source_prefix, target_prefix, primary_keys):
    """
