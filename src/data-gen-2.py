...
loan_data_gen = (DataGenerator(spark, name="loan_data", rows=100000, partitions=4)
                 ...
                 .withColumn("co_borrower_id", "string", expr="uuid()", percentNulls=0.7)
                 .withColumn("guarantor_id", "string", expr="uuid()", percentNulls=0.9)
                 .withColumn("insurance_type", "string", values=["Life", "Disability", "Property", "None"], percentNulls=0.4)
...
customer_df.show(5)
print("Branch Data Sample:")
branch_df.show(5)
print("Underwriter Data Sample:")
underwriter_df.show(5)
print("Loan Type Data Sample:")
loan_type_df.show(5)
print("Insurance Data Sample:")
insurance_df.show(5)